...
const Home = () => {
    return (
        <div>
            <div className='my-container bg-gray-200 lg:py-8 lg:px-8 sm:py-4 flex flex-col items-center justify-between lg:flex-row'>
          ...
          >
            Learn More
                ...
                <div className='relative lg:w-1/2 py-4'>
